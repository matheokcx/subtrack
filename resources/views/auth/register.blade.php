...
<head>
    ...
    <title>Subtrack - Inscription</title>
</head>
...
<div class="w-1/3 h-2/3 rounded-3xl bg-white/45 flex flex-col items-center gap-16 pt-8">
    ...
    <form action="{{route("register")}}" method="POST" class="w-full flex flex-col items-center gap-12">
        @csrf
        <input type="text" name="name" placeholder="Votre nom" class="w-3/4 h-9 rounded-2xl p-2 border-2 border-gray-400 text-black">
        ...
        <input type="text" name="password_confirmation" placeholder="Confirmer votre mot de passe" class="w-3/4 h-9 rounded-2xl p-2 border-2 border-gray-400 text-black">
